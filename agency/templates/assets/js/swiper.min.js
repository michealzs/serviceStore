...
!(function (e, t) {
    ...
    const re = [
        ...
        function (e) {
            ...
            te({
                ...
                setTranslate: () => {
                        ...
                        if (u)
                            m.transform(
                                `translate3d(0px, ${r / 2 + p.shadowOffset}px, ${
                                    -r / 2
                                }px) rotaX(90deg) rotaZ(0deg) scale(${p.shadowScale})`
                            );
                        else {
                    ...
                    s.transform(
                        `translate3d(0px,0,${g}px) rotaX(${t.isHorizontal() ? 0 : f}deg) rotaY(${
                            t.isHorizontal() ? -f : 0
                        }deg)`
                    ),
            ...
            te({
                ...
                setTranslate: () => {
                    ...
                    for (let r = 0; r < e.length; r += 1) {
                        ...
                        const h = `translate3d(${p}px, ${u}px, 0px) rotaX(${c}deg) rotaY(${d}deg)`;
                        se(a, n).transform(h);
                    }
                },
                setTransition: (e) => {
                ...
                te({
                    ...
                    setTranslate: () => {
                        ...
                        for (let e = 0, t = a.length; e < t; e += 1) {
                            ...
                            const b = `translate3d(${v}px,${g}px,${m}px)  rotaX(${h}deg) rotaY(${u}deg) scale(${w})`;
                            if (
                                (se(r, t).transform(b),
        ...
        function (e) {
            ...
            s({
                creativeEffect: {
                    ...
                    perspective: !0,
                    prev: { translate: [0, 0, 0], rota: [0, 0, 0], opacity: 1, scale: 1 },
                    next: { translate: [0, 0, 0], rota: [0, 0, 0], opacity: 1, scale: 1 },
                },
            });
            ...
            te({
                ...
                setTranslate: () => {
                    ...
                    for (let s = 0; s < e.length; s += 1) {
                        ...
                        let f = { translate: [0, 0, 0], rota: [0, 0, 0], scale: 1, opacity: 1 };
                        d < 0 ? ((f = r.next), (m = !0)) : d > 0 && ((f = r.prev), (m = !0)),
                            u.forEach((e, t) => {
                                u[t] = `calc(${e}px + (${i(f.translate[t])} * ${Math.abs(d * n)}))`;
                            }),
                            h.forEach((e, t) => {
                                h[t] = f.rota[t] * Math.abs(d * n);
                            }),
                            (a[0].style.zIndex = -Math.abs(Math.round(o)) + e.length);
                        const g = u.join(", "),
                            v = `rotaX(${h[0]}deg) rotaY(${h[1]}deg) rotaZ(${h[2]}deg)`,
        ...
        function (e) {
            let { swiper: t, extendParams: s, on: a } = e;
            s({
                cardsEffect: { slideShadows: !0, transformEl: null, rota: !0, perSliderota: 2, perSlideOffset: 8 },
            }),
                te({
                    effect: "cards",
                    swiper: t,
